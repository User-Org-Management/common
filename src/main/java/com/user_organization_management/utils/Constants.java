...
public class Constants {
    ...
    public static final String ORG_NOT_FOUND = "Organization with not found";
    public static final String ORG_NOT_FOUND_WITH_ID = "Organization with id %S not found";

    public static final String ORG_NAME_EXISTS = "Organization name %s  already exists";
